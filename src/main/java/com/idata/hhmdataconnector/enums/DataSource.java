...
public enum DataSource {
    ...
    HHM( "jdbc:mysql://172.87.7.249:3306/contradiction?useSSL=false", "root", "idata@2023"),
    //警民联调原始数据
    JMLT_ORIGIN( "jdbc:mysql://172.87.7.249:3306/jmlt_origin?useSSL=false", "root", "idata@2023"),
    //促法原始数据
    CF_ORIGIN( "jdbc:mysql://172.87.7.249:3306/cf_origin?useSSL=false", "root", "idata@2023");
    private String url;
    private String user;
