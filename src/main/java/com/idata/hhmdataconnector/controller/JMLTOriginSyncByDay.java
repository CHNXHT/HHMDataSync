...
public class JMLTOriginSyncByDay {
    ...
    public Result jmltv_sjgxr() throws SQLException {
        ...
        String targetdatabasename = DatabaseTable.JMLTV_SJGXR.getTargetdatabasename();
        ...
        RawDataSync.MultisyncData(databasename,targetdatabasename,tablename,raw,"GXSJ",begintime,endtime);
    ...
    public Result jmltv_sjlx() throws SQLException {
        ...
        String targetdatabasename = DatabaseTable.JMLTV_SJLX.getTargetdatabasename();
        String beginTimeStr = DateUtil.parse(begintime).toString("yyyyMMddHHmmss");
        String endTimeStr = DateUtil.parse(endtime).toString("yyyyMMddHHmmss");
        //数据入库前删除当前时间段表数据
        deleteTableBeforeInsert(tablename, url,targetdatabasename, pasword, beginTimeStr,endTimeStr,"GXSJ","1");
        RawDataSync.MultisyncData(databasename,targetdatabasename,tablename,raw,"GXSJ",begintime,endtime);
    ...
    public Result jmltv_sjxx() throws SQLException {
        ...
        String targetdatabasename = DatabaseTable.JMLTV_SJXX.getTargetdatabasename();
        String beginTimeStr = DateUtil.parse(begintime).toString("yyyyMMddHHmmss");
        String endTimeStr = DateUtil.parse(endtime).toString("yyyyMMddHHmmss");
        //数据入库前删除当前时间段表数据
        deleteTableBeforeInsert(tablename, url,targetdatabasename, pasword, beginTimeStr,endTimeStr,"GXSJ","1");
    ...
    public Result jmltv_spjg() throws SQLException {
        ...
        String targetdatabasename = DatabaseTable.JMLTV_SPJG.getTargetdatabasename();
        String beginTimeStr = DateUtil.parse(begintime).toString("yyyyMMddHHmmss");
        String endTimeStr = DateUtil.parse(endtime).toString("yyyyMMddHHmmss");
        //数据入库前删除当前时间段表数据
        deleteTableBeforeInsert(tablename, url,targetdatabasename, pasword, beginTimeStr,endTimeStr,"SPSJ","1");
        RawDataSync.MultisyncData(databasename,targetdatabasename,tablename,raw,"SPSJ",begintime,endtime);
        return Result.SUCCESS(begintime+"日："+"V_SPJG 数据同步成功");
    }
}
